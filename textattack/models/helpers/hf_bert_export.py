...
def extract_bert_weights(
    ...
    hf_model.save_pretrained(filename)
    encoder_state_dict = BertModel.from_pretrained(filename).state_dict()
...
if __name__ == "__main__":
    ...
    input_huggingface_bert_model_path = "/home/tangshi/code/TextAttack-A2T/example/checkpoint-epoch-1"
    hf_model = BertModel.from_pretrained(input_huggingface_bert_model_path)
    head_number = 12
